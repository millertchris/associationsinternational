...
module.exports = {
  init: function () {
    $('.layout.accordion .accordion-item .accordion-title').on('click', function (evt) {
      ...
      $(this).parent().find('.accordion-content').slideToggle('3000', function () {// Animation complete.
      });
    });
  }
};
...
var anime = require('animejs'); // var lottie = require('lottie-web');
...
},{"animejs":1,"jquery":2}],6:[function(require,module,exports){
var $ = require('jquery');
...
module.exports = {
  init: function () {
    ...
    document.addEventListener('scroll', function (event) {
      var scrollY = window.pageYOffset; // console.log('scroll event - ' + scrollY);
...
},{"jquery":2,"slick-carousel":3}],9:[function(require,module,exports){
var $ = require('jquery');
...
var $ = require('jquery'); // var jQuery = require('jquery');
...
var menu = require('./modules/menu.js'); // var selects = require('./modules/selects.js');
...
var svg = require('./modules/svg.js'); // styleguide.init();
...
animations.init();
cards.init();
menu.init(); // selects.init();

sliders.init();

},{"./modules/accordions.js":4,"./modules/animations.js":5,"./modules/cards.js":6,"./modules/menu.js":7,"./modules/sliders.js":8,"./modules/style-guide.js":9,"./modules/svg.js":10,"jquery":2,"slick-carousel":3}]},{},[11])
